      ...
      <main className="py-16 px-8 pt-32">
        <div className="container max-w-4xl mx-auto">
          ...
          <Card className="bg-card/50 border border-primary/20 backdrop-blur-lg">
            ...
            <CardContent>
              <div
                className="prose prose-invert max-w-none text-foreground/90 prose-p:leading-relaxed prose-headings:text-foreground prose-headings:font-bold prose-h2:text-2xl prose-h2:mt-10 prose-h2:mb-4 prose-strong:text-primary"
