  ...
  return (
    <section className="py-16 px-8">
      <div className="container max-w-7xl mx-auto">
        <div className="mid-cta bg-gradient-to-br from-[rgba(16,185,129,0.1)] to-[rgba(16,185,129,0.05)] border border-[rgba(16,185,129,0.2)] rounded-2xl p-12 text-center max-w-2xl mx-auto backdrop-blur-lg">
